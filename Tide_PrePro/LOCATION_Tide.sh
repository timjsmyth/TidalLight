...
cat new-file | awk 'BEGIN {FS=","};{printf("%02d/%02d/%04d %02d:00:00, %5.3f\n", $3,$2,$1,$4,$5/1000.)}' > $fname_new
#sed -i "s/,/ /3" new-file
#sed -i "s/,/\//2" new-file
#sed -i "s/,/\//1" new-file
#sed -i "s/[^0-9 .,:/ -]*//g" new-file # remove all characters except those inlcuded in the []
